...
/** */
export const getStaticPathsBlogList = async (paginate: PaginateFunction) => {
...
/** */
export const getStaticPathsBlogCategory = async (paginate: PaginateFunction) => {
...
/** */
export const getStaticPathsBlogTag = async (paginate: PaginateFunction) => {

...
import SimpleOverviewDemo from '@/components/course/neural-networks/SimpleOverviewDemo';
...
<SimpleOverviewDemo client:visible />
...
<CallToAction
  callToAction={{
    text: 'Get template',
    href: 'https://github.com/ace-han/madeinace-site',
